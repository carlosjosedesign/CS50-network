...
class FormsTestCase(TestCase):
    def test_user_profile_form_img_too_big(self):
        ...
        with open(test_img_path, "rb") as infile:
            ...
            form = CreateProfileForm(files={"image": img_file})
...
class ViewsTestCase(TestCase):
    ...
    def test_POST_post_comment_create_comment(self):
        """ Create a comment -> check if comment exists and if user is and return json """
        # Login user
        self.c.login(username="test", password="test")
    ...
    def test_POST_follow_unfollow_correct(self):
        ...
        self.assertEqual(response_follow.status_code, 201)
        ...
        # Make sure status is successful
        self.assertEqual(response_unfollow.status_code, 201)
